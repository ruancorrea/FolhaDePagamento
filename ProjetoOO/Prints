...
public abstract class Prints {
    protected static void EscolhaTipo()
    {
        System.out.println("|------------------------------------------------|");
    ...
    protected static void Inicializando(Empresa P3)
    {
        System.out.println("|-----------------------------------------------|");
    ...
    protected static void MenuEmp(Empresa P3)
    {
        System.out.println("|-----------------------------------------------|");
    ...
    protected static void MenuAdm(Empresa P3)
    {
        System.out.println("|-----------------------------------------------|");
        System.out.println("                       MENU                  ");
        System.out.println("                                        ");
    ...
    protected static void Alteracao(Empresa P3)
    {
        System.out.println("|-----------------------------------------------|");
    ...
    protected static void ficha(Funcionario F)
    {
        System.out.println();
        System.out.println("|-----------------------------------------------------------------------------|");
    ...
    protected static boolean ListaEmpregados(Funcionario[] Lista, int tam)
    {
        int i=0;
        boolean tem = false;
        while(i < tam)
    ...
    protected static void ListaInformacoesEmpregados(Funcionario[] Lista, int tam)
    {
        int i=0;
        boolean tem = false;
        while(i<tam)
    ...
    protected static void novoTipo()
    {
        System.out.println("|-----------------------------------------------------|");
    ...
    protected static void novoMetodo()
    {
        System.out.println("|-------------------------------------------------------|");
    ...
    protected static void NaoFazParte()
    {
    ...
    protected static void QuerFazer()
    {
    ...
    protected static void nvagenda()
    {
        System.out.println("|----------------------------------------|");
