...
public abstract class FolhaDePagamento {
    ...
    public static void RodaFolha(Empresa P3)
    {
        ...
        for(int i=0; i< P3.getTamanho(); i++)
        {
            ...
            if(Lista[i].getPagamento().equals(P3.getData()) && Lista[i].getID() != -1)
            {
                ...
                FolhaDePagamento.CalculoSalario(Lista[i]);
                ...
                String pagamento = FolhaDePagamento.CalcularDiaPagamento(P3, Lista[i], data.getActualMaximum (Calendar.DAY_OF_MONTH));
